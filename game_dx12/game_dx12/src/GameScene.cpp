...
#endif
	if (!snow_boad)
		snow_boad = std::make_unique<KDL::DX12::Geometric_Board_S>(p_app, "data\\images\\雪.png", 1);

	if (!sand_boad)
		sand_boad = std::make_unique<KDL::DX12::Geometric_Board_S>(p_app, "data\\images\\砂漠.png", 1);
