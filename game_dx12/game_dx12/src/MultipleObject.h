...
public:
	...
	static constexpr float DeathDropColorScale{ 0.8f };	//元の色の  80%　で出力
	static constexpr float DeathDropTime{ 0.5f };		//0.5秒で消える
	static constexpr float DeathDropLength{ -0.5f };	//DeathDropTime秒で y が -0.5 落下する
private:
