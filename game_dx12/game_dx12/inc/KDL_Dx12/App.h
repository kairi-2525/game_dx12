...
namespace KDL
{
	namespace DX12
	{
		...
		private:
			...
			static inline const UINT ALLOCATOR_COUNTER_MAX = 3;	//Windows�̏ꍇ�A�T�u�~�b�g���ꂽ�R�}���h�̎��s��3�t���[���x������܂��B
		public:
		...
		public:
			...
			ID3D12GraphicsCommandList* GetCommandList(size_t num = 0u) { assert(m_worker_threads[m_frame_index].size() > num && "����num�ɑΉ�����R�}���h���X�g������܂��񂌁B");  return m_worker_threads[m_frame_index][num].command_list.Get(); }
